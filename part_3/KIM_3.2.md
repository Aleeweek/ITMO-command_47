# КИМ 3.2. Лабораторная работа. Документоориентированные и поисковые БД

Полное название темы: использование технологий в задачах анализа текстов и построения моделей NLP. Организация корпуса текстов для обучения модели классификации/тональности. Форматы хранения: JSON, BSON, Avro, Parquet.
...
### Цель 
закрепить работу с документо-ориентированными и освоить поисковые СУБД.
