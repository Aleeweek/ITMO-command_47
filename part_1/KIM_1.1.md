...
База данных предназначена для автомобильного сервиса (СТО) и охватывает его основные бизнес-процессы: обслуживание клиентов, учёт заказов и услуг, управление персоналом, склад запчастей, финансы и отзывы. В базе данных контролируется условие один механик – один заказ, исключающее возможность назначения одного и того же механика на несколько заказов одновременно. Разработана функция для расчета полной стоимости заказов с учетом оказанных услуг и использованных запчастей.
